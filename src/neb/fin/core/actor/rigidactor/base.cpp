...
{}*/
std::weak_ptr<neb::core::core::shape::base>		neb::fin::core::actor::rigidactor::base::createShapeBoxUninitialized(
		glm::vec3 size)
{
...
std::weak_ptr<neb::core::core::shape::base>		neb::fin::core::actor::rigidactor::base::createShapeBox(neb::core::math::pose pose, glm::vec3 size) {
	LOG(lg, neb::core::sl, debug) << __PRETTY_FUNCTION__;
